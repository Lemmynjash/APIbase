...
> One MCP endpoint. 500 tools. 157 providers. Pay per call with x402 (USDC on Base) or MPP (USDC on Tempo).
...
## Tool Categories (500 tools, 157 providers)
...
| **Entertainment** | 28 | TMDB, Ticketmaster, RAWG, IGDB, Jikan, Met Museum, Rijksmuseum | Movies, events, games, anime, art collections |
